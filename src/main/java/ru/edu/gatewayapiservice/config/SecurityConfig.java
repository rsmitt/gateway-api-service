...
import ru.edu.gatewayapiservice.security.jwt.JwtAuthorizationFilter;
import ru.edu.gatewayapiservice.security.jwt.JwtProviderImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.cors(Customizer.withDefaults()) // настраиваем cors что бы работать с react
                ...
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .requestMatchers(HttpMethod.GET, "/gateway/book").permitAll()
                        .requestMatchers("/gateway/book/**").hasRole(Role.ADMIN.name())
